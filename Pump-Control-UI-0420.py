...
class PumpControlApp(QMainWindow):
    def __init__(self):
        ...
        self.instruction_label.setText('Instruction:\n'
                                       'Step 1. Set correct port and baudrate, click "Connect" to build connection;\n'
                                       'Step 2. Check rows according to the number of the pumps need to be used;\n'
                                       'Step 3. Enter the required parameters then click "Set Select";\n'
                                       'Step 4. Using "Run Select" or "Stop Select" to control the status of the pumps.\n'
                                       '\nNote: Diameters for 1ml syringe is 4.7 mm')
        self.instruction_label.setStyleSheet("background-color:#b7e4c7")
        self.instruction_label.setAlignment(Qt.AlignCenter)
        self.instruction_label.setWordWrap(True)
        self.instruction_label.setGeometry(40, self.height() - 140, 730, 100)
